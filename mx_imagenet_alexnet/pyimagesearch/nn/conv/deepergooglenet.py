...
class DeeperGoogLeNet:
    ...
    def inception_module(x, num1x1, num3x3Reduce, num3x3, num5x5Reduce,
        ...
        second = DeeperGoogLeNet.conv_module(x, num3x3Reduce, 1, 1, (1, 1), chanDim, reg=reg,
                                             name=stage+'_second1')
        second = DeeperGoogLeNet.conv_module(second, num3x3, 3, 3, (1, 1), chanDim,
                                             reg=reg, name=stage+'_second2')

        third = DeeperGoogLeNet.conv_module(x, num5x5Reduce, 1, 1, (1, 1), chanDim,
                                            reg=reg, name=stage+'_third1')
        third = DeeperGoogLeNet.conv_module(third, num5x5, 5, 5,
                                            (1, 1), chanDim, reg=reg, name=stage+'_third')

        fourth = MaxPooling2D((3, 3), strides=(1, 1),
                              padding='same', name=stage+'_pool')(x)
        fourth = DeeperGoogLeNet.conv_module(fourth, num1x1Proj,
                                             1, 1, (1, 1), chanDim, reg=reg,
                                             name=stage+"_fourth")
