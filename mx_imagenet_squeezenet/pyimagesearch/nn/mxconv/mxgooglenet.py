...
class MxGoogLeNet:
    ...
    def inception_module(data, num1x1, num3x3Reduce, num3x3, num5x5Reduce, num5x5, num1x1Proj):
        conv1x1 = MxGoogLeNet.conv_module(data, num1x1, 1, 1)
        ...
        concat = mx.sym.Concat(*[conv1x1, conv_3x3, conv5x5, conv_proj])
    ...
    def build(classes):
        ...
        in4d = MxGoogLeNet.inception_module(in4c, 112, 144, 288, 32, 128, 128)
        ...
        pool5 = mx.sym.Pooling(data=in5b, pool_type='max', kernel=(7, 7), stride=(1, 1))
